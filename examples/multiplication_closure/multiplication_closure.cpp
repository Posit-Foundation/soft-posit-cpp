...
void saveMultiplicationImage(const std::vector<std::vector<ResultType>>& resultMatrix, const char* filename) {
...
int main() {
    ...
    std::vector<std::vector<ResultType>> resultMatrix(IMAGE_SIZE, std::vector<ResultType>(IMAGE_SIZE));
